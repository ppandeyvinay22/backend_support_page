...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function displayPage(pageNumber) {
    ...
    filteredData.slice(startIndex, endIndex).forEach(data => {
      ...
      let support_state = data[4] ? data[4].toLowerCase() : null;
      let support_priority = data[5] ? data[5].toLowerCase() : null;
      let Issue_type = data[2] ? data[2].toLowerCase() : null;
      let ticket_id = data[0];
      let error_detail = (data[3]) ? data[3].toLowerCase() : null;
      let raised_by = data[7] ? data[7].toLowerCase() : null;
      let assigned_to = data[6] ? data[6].toLowerCase() : null;
      let support_mode = data[8] ? data[8].toLowerCase() : null;
